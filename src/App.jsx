      ...
      <footer>
        <div className="container footer-content">
          ...
          <div className="footer-links" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <a href="https://www.instagram.com/mackenagency/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', transition: 'color 0.3s ease' }} title="Instagram">

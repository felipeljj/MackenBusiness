      ...
      <footer>
        <div className="container footer-content">
          <div className="footer-logo">
            <img src="/macken-logo.png" alt="Logo MACKEN" className="logo-svg-small" />
          </div>
          <div className="footer-links" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            <p style={{ margin: 0 }}>&copy; {new Date().getFullYear()} MACKEN B2B White Label. Todos os direitos reservados.</p>
